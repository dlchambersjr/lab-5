...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var messageOne = (a.toString().concat(' and ',b,' and ',c,' sum to ',outputOne,'.'));
  var messageTwo = 'The product of '.concat(a,' and ',b,' and ',c,' is ',outputTwo, '.');
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var message = (sumArr.toString()).concat(' was passed in as an array of numbers, and ',output,' is their sum.');
  return [output,message];
}
...
var message = 'The numbers '.concat(multArr,' have a product of ',output, '.');
return [output, message];
}
...
// Once you get the test passing, dos an a-c-p cycle and synchronize the code between GitHub and your laptop. 
...
var i = 0;
var formula = 'multiply(multiply('
console.log(i,formula);
  if (dynamicArray%2 !== 0) {
    while (i < dynamicArray.length/2){
      formula = formula.concat('multiply(dynamicArray\[',i,'\],dynamicArray\[',i+1,'\])\[0\],');
      console.log(i,formula);
      i+=2;
    }
  formula = formula.slice(0,-1);
  console.log(formula);
  formula = formula.concat(')\[0\],dynamicArray\[',dynamicArray.length-1,'\])\[0\]');
  console.log(formula);
  var output = eval(formula);
  console.log(output);
  var message = 'The numbers '.concat(dynamicArray,' have a product of ', output,'.');
  console.log(message);
